...
const AirtableController = __importStar(require("../controllers/airtable.controller"));
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authenticate); // Protect all routes in this file
// /api/airtable/bases
